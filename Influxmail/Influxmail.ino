...
// WiFi AP SSID
#define WIFI_SSID "CenturyLink8120" // "Bairfam_5GEXT"
// WiFi password
#define WIFI_PASSWORD "rb54gti37e7gnx"   // "bairfam5"
// InfluxDB v2 server url, e.g. https://eu-central-1-1.aws.cloud2.influxdata.com (Use: InfluxDB UI -> Load Data -> Client Libraries)
#define INFLUXDB_URL "https://eastus-1.azure.cloud2.influxdata.com"
// InfluxDB v2 server or cloud API token (Use: InfluxDB UI -> Data -> API Tokens -> Generate API Token)
#define INFLUXDB_TOKEN "P90zBVkaiy21LDrrhssUkSQty05kyq78OCXzXLSwjeloxpFDb6TKhoypXIMrzZpfktC2TnRb-pguP93zQi4MdQ=="
